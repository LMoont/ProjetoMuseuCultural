...
void questArteModrn(){
    ...
    printf("\t\t\t\t2 - Qual foi um dos principais objetivos da Semana de Arte Moderna?\n\n\n");
    printf("\t\t\t\ta) Romper com o academicismo vigente na arte brasileira.\n\n");
    printf("\t\t\t\tb) Incentivar a segregação das manifestações populares e regionais.\n\n");
    printf("\t\t\t\tc) Introduzir as técnicas de pintura renascentista nas produções\n\t\t\t\tartísticas.\n\n");
    printf("\t\t\t\td) Promover a venda de obras de arte moderna exclusivamente para a elite\n\t\t\t\tbrasileira.\n\n");
    printf("\t\t\t\tResp: ");
    scanf(" %c", &resp);
    getchar();
    ...
    printf("\t\t\t\t3 - Qual foi a reação inicial do público em relação às obras e\n\t\t\t\tperformances apresentadas?\n\n\n");
    printf("\t\t\t\ta) Aceitação imediata e entusiasmo generalizado.\n\n");
    printf("\t\t\t\tb) Aplausos unânimes e apoio incondicional.\n\n");
    printf("\t\t\t\tc) Ressentimentos e rejeições intensas.\n\n");
    printf("\t\t\t\td) Indiferençaa e falta de interesse.\n\n");
    printf("\t\t\t\tResp: ");
    scanf(" %c", &resp);
